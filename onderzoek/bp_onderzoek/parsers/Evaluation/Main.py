...
doubleDictionaryList, triDictionaryList, allTokenList = dictionaryBuilder(Zookeeper_format, '../../logs/Zookeeper/Zookeeper_2k.log', Zookeeper_Regex)
tokenMatch(allTokenList,doubleDictionaryList,triDictionaryList,15,10,'output/Zookeeper')
f_measure, accuracy = evaluate('../../logs/Zookeeper/Zookeeper_2k.log_structured.csv', './output/ZookeeperEvent.csv')
